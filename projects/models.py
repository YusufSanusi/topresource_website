...
def validate_video_file(value):
    ...
    # This is a basic implementation - for production, consider using python-magic library
...
class Project(models.Model):
    ...
    thumbnail = ImageField(blank=True, null=True, upload_to='thumbnails/', default='thumbnails/default-video.png')
